  ...
  return (
    <div className="space-y-1">
      ...
      <p className="text-[10px] text-muted-foreground text-center">
        ...
        {zoneType ? ` · ${({'residential-exclusive-1':'제1종 전용주거','residential-exclusive-2':'제2종 전용주거','residential-1':'제1종 일반주거','residential-2':'제2종 일반주거','residential-3':'제3종 일반주거','residential-general-1':'제1종 일반주거','residential-general-2':'제2종 일반주거','residential-general-3':'제3종 일반주거','semi-residential':'준주거','commercial-general':'일반상업','commercial-neighborhood':'근린상업','commercial-central':'중심상업','general-commercial':'일반상업','neighborhood-commercial':'근린상업','central-commercial':'중심상업','distribution-commercial':'유통상업','exclusive-industrial':'전용공업','general-industrial':'일반공업','semi-industrial':'준공업','natural-green':'자연녹지','production-green':'생산녹지','conservation-green':'보전녹지','green-natural':'자연녹지','conservation-management':'보전관리','production-management':'생산관리','planning-management':'계획관리','rural-village':'농림','natural-environment':'자연환경보전'} as Record<string,string>)[zoneType] || zoneType}` : ''}
      </p>
    </div>
  )
}
